...
class MysqlDao {
    ...
    public function getPropositionsByVol($villedep, $villearrivee){
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            $result[] = new Vol(NULL, $lieuDepart, $lieuArrivee, $dateHeureDepart, NULL, NULL,NULL,NULL,NULL,NULL,NULL,NULL);                
        }return $result;
    }
