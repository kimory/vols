        ...
        <div id="container">
            ...
            <div id="developpement">
                ...
                <div id="enregistrementpassager">
                    <form action="/EnregistrementPassagersC" method="POST" >
                        <fieldset>
                            ...
                            while ($i <= $_SESSION['nb_passagers']) {
                                ...
                                <fieldset>
                                    ...
                                    <select name='civilite[]' id='civilite<?php echo $i; ?>' >
                                        <option
                                        <?php
                                        // attention le premier passager est à l'indice zéro !
                                        ...
                                        <option 
                                        <?php
                                        if (isset($_POST['civilite'][$i - 1]) && strcmp($_POST['civilite'][$i - 1], 'mme') == 0)
                                            echo 'selected="selected"';
                                        ?>
