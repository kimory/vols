...
class ContactController {
    ...
    public function action() {
        ...
        if(!isset($_POST['nom']) || strlen($_POST['nom']) == 0 ){            
            ...
            $messages[] = "Votre saisie 'nom' est incorrecte";
        }else{
        ...
        if(!isset($_POST['prenom']) || strlen($_POST['prenom']) == 0 ){
            ...
            $messages[] = "Votre saisie 'prenom' est incorrecte";
        } else {            
        ...
        if(isset($_POST['tel']) && preg_match("/^[0-9]{10,20}$/",$_POST['tel'])){
            ...
            $messages[] = "Votre saisie 'telephone' est incorrecte.";
        }
                
        if(isset($_POST['message']) && strlen($_POST['message']) > 0 ) {
            $message = htmlentities($_POST['message'], ENT_QUOTES, 'UTF-8');
        } else {
            $messages[] = "Votre saisie 'message' est incorrecte.";
        }
