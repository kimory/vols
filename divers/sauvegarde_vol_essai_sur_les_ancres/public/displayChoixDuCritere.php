...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="tab-content">
            <?php if($anchor === "vol"):?>
           <div class="tab-pane active" id="vol" style="display:block">
                <h3>Vol</h3>
            ...
            <?php elseif($anchor === "passager"):?>
            <div class="tab-pane" id="passager" style="display:block">
                <h3>Passager</h3>
 ...
 <?php elseif($anchor === "employe"): ?>
            <div class="tab-pane" id="employe" style="display:block">
                <h3>Employé</h3>
 ...
 <?php elseif($anchor === "reservation"):?>
            <div class="tab-pane" id="reservation" style="display:block">
                <h3>Réservation</h3>
 ...
 <?php elseif($anchor === "client"):?>
            <div class="tab-pane" id="client" style="display:block">
                <h3>Client</h3>
